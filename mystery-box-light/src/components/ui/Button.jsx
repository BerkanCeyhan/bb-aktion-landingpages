...
const Button = React.forwardRef(({ className, variant = "primary", size = "default", children, ...props }, ref) => {
    ...
    const variants = {
        primary: "bg-brand-orange text-brand-bg hover:bg-brand-volt cursor-pointer",
        outline: "border-2 border-brand-orange text-brand-orange hover:bg-brand-orange/10 cursor-pointer",
        ghost: "text-brand-text hover:text-brand-orange hover:bg-brand-surface cursor-pointer",
        accent: "bg-brand-volt text-brand-bg hover:bg-brand-orange cursor-pointer",
    };
