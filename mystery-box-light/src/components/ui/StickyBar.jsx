    ...
    return (
      ...
      `}
        >
            ...
            <div className="bg-brand-surface border-t border-brand-surface2 py-4 px-4 shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
                <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">

                    <div className="hidden sm:flex items-center gap-4">
                        <div className="bg-brand-bg p-2 border border-brand-surface2">
                            <img src={`${import.meta.env.BASE_URL}XL_Variante.png`} alt="Box" className="w-10 h-10 object-contain" />
                        </div>
                        <div>
                            <p className="font-drama text-brand-text tracking-wide truncate w-48 lg:w-64">Brustbizeps Mystery Box</p>
                            <div className="flex items-center gap-1">
                                <span className="text-brand-orange text-xs">★★★★★</span>
                                <span className="text-brand-muted font-mono text-xs">4.8/5</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex w-full sm:w-auto items-center gap-4">
                        ...
                        <div className="text-right hidden sm:block">
                            <p className="font-bold text-brand-text line-through opacity-50 text-sm">Ab 89,90€</p>
