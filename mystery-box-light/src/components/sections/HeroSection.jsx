        ...
        <section ref={heroRef} className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden py-20 px-4 md:px-8">
            ...
            <div className="relative z-10 max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 w-full">
                ...
                <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-surface border border-brand-orange/30 rounded-full text-brand-orange font-mono text-sm mb-6 shadow-sm">
                        <Zap size={16} className="text-brand-orange animate-pulse" />
                        <span>Limitiert: Nur noch 47 Boxen verfügbar</span>
                    </div>

                    <h1 ref={headlineRef} className="text-6xl md:text-7xl lg:text-8xl font-black text-brand-orange uppercase leading-[0.9] mb-6 tracking-tighter">
                        Mehr Inhalt. <br />
                        <span className="text-brand-volt">Weniger Preis.</span><br />
                        <span className="text-brand-orange">Nur Premium.</span>
                    </h1>

                    <p ref={subRef} className="text-xl md:text-2xl text-brand-muted font-sans max-w-2xl mb-10 leading-relaxed">
                        Die Brustbizeps Mystery Box. Keine Restposten, kein Müll. Nur verifizierte Bestseller für deinen Muskelaufbau mit <strong className="text-brand-text">40-80% Rabatt</strong>.
                    </p>
                    ...
                    <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                        ...
                        <div className="flex items-center justify-center sm:justify-start gap-2 text-brand-muted font-mono text-sm mt-2 sm:mt-0">
                ...
                <div className="flex-1 w-full max-w-none md:max-w-md lg:max-w-full relative h-[400px] md:h-[500px] flex items-center justify-center mt-10 lg:mt-0">
                    ...
                    <div ref={boxRef} className="relative z-20 w-64 h-64 md:w-80 md:h-80">
                        <img
