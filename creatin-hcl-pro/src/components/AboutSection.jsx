...
export default function AboutSection() {
    ...
    return (
        <section ref={sectionRef} className="py-24 px-4 bg-brand-bg relative border-t border-brand-text/5 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
                ...
                <div className="w-full md:w-5/12 relative">
                    <div className="about-element relative aspect-[3/4] max-w-sm mx-auto md:mx-0">
                        ...
                        />
                        <div className="absolute -bottom-6 -left-6 z-20 bg-brand-surface border border-brand-text/10 p-4 shadow-2xl backdrop-blur-md">
                            <span className="font-mono text-brand-accent uppercase text-xs tracking-widest block mb-1">
                                STATUS: GEPRÜFT
                            </span>
                            <span className="font-heading uppercase text-brand-text tracking-wide">
                                Fatmir Adzaj
                            </span>
                        </div>
                    </div>
                ...
                <div className="w-full md:w-7/12 mt-8 md:mt-0">
                    ...
                    <p className="about-element text-xl md:text-2xl font-drama text-brand-text/50 mb-8 leading-snug">
                        Kein Konzern. Kein anonymes Labor. Ein Gründer, der selbst weiß, wie es ist, wenn Creatin nicht funktioniert.
                    </p>

                    <div className="about-element space-y-6 text-brand-text/70 font-body text-base md:text-lg leading-relaxed">
                        <p>
                        ...
                        <p className="pl-4 border-l-2 border-brand-accent text-brand-text italic">
