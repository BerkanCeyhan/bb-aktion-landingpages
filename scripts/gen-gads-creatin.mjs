#!/usr/bin/env node
/**
 * Bildmotive fuer die Google-Ads-PMax-Kampagne Creatin HCL (BrustBizeps)
...
const OUTDIR = "assets/ads/creatin-hcl";
const REF = "assets/ads/creatin-hcl/ref-hcl-dose.jpg";

/* Der Key wird nie ausgegeben, nicht ins Log und nicht in eine URL.
   Gesucht wird in dieser Reihenfolge: Umgebung, gemeinsame Konfig, Repo-.env.
   Bewusst NICHT im Wellenpuls-Repo — dessen .env gehoert einem anderen Kunden. */
function loadKey() {
