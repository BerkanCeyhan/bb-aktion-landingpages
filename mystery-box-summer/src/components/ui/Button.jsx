...
const Button = React.forwardRef(({ className, variant = "primary", size = "default", children, ...props }, ref) => {
    ...
    const variants = {
        primary: "bg-brand-orange text-dark-text hover:bg-brand-volt hover:text-dark-surface box-shadow-neon hover:box-shadow-volt cursor-pointer",
        ...
        accent: "bg-brand-volt text-dark-surface hover:bg-brand-orange hover:text-dark-text box-shadow-volt hover:box-shadow-neon cursor-pointer",
    };
