...
export function InterestSection() {
    ...
    const features = [
        {
            icon: <ShieldAlert size={40} className="text-brand-teal mb-4" />,
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {features.map((feature, idx) => (
                        <div
                            key={idx}
                            ref={addToCards}
                            className="bg-dark-surface p-8 rounded-3xl border border-dark-surface2 shadow-[0_12px_30px_-18px_rgba(42,26,11,0.35)] hover:-translate-y-1 hover:border-brand-volt/60 hover:shadow-[0_22px_44px_-20px_rgba(255,46,126,0.4)] transition-all duration-300 ease-out group"
                        >
